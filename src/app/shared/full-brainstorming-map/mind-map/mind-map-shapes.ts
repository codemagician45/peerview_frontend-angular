...
export class MindMapShapes {
  ...
  public setRect (elem, radius): void {
    elem
      .append('rect')
  ...
  public setCircle (elem, radius): void {
    elem
      .append('circle')
  ...
  public setHexagon (elem, radius): void {
  ...
  public setTriangle (elem, radius): void {
  ...
  public setStar (elem, radius): void {
  ...
  public setPentagon (elem, radius): void {
  ...
  public setDragHelper (elem, d, initialRadius): void {
  ...
  public getData (corners, radius, shift): Array<any> {
    let data = [];
  ...
  private getCoords (corners, R, i, shift = 0): any {
