...
docker push peersview/peersview-front:v0.0.7
...
docker pull peersview/peersview-front:v0.0.7

# Stop the existing running container

# Start New Container (Wait for 3 minutes)
docker run -d --rm --name peersview-front --publish 443:443 peersview/peersview-front:v0.0.7
```
