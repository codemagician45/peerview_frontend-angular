...
export class CourseService {
    ...
    getSubInterest(interestCategoryId){
    ...
    getCountryCities(countryId: Number=1) {
    ...
    getInterests(categoryId: Number){
    ...
    getNewsStories() {
        const stories = [
            {"id":1, "source":"IBTimes", "url":"cnn.com", "title":"Breakthrough computer program detects cancer before symptoms arise", "time":"18.02"},
            {"id":2, "source":"CNN", "url":"cnn.com", "title":"Breakthrough computer program detects cancer before symptoms arise", "time":"18.02"},
            {"id":3, "source":"BBC News", "url":"bbcnews.com", "title":"Breakthrough computer program detects cancer before symptoms arise", "time":"18.02"},
            {"id":4, "source":"Aljazeera", "url":"cnn.com", "title":"Breakthrough computer program detects cancer before symptoms arise", "time":"18.02"},
            {"id":5, "source":"Manchester Metro", "url":"cnn.com", "title":"Breakthrough computer program detects cancer before symptoms arise", "time":"18.02"},
            {"id":6, "source":"CNN", "url":"cnn.com", "title":"Breakthrough computer program detects cancer before symptoms arise", "time":"18.02"},
        ];
